<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\meau\index.html";i:1639920798;s:60:"../addons/wjyk_nhyk/application/admin/view/index/footer.html";i:1641211050;}*/ ?>
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">菜单栏列表</div>
                <div class="layui-card-body">
                    <div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn" data-type="addFirst">添加菜单栏</button>
                    </div>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url:"<?php echo siteUrl('admin/meau/meau_list','','web'); ?>"
            ,cols: [[
                {field:'order',  title: '排序值', sort: true}
                ,{field:'meau_name',  title: '菜单栏名称' }
                
                ,{field:'meau_link',  title: '菜单栏链接', sort: true}
        ...
        table.on('tool(test-table-operate)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('确定删除该菜单栏吗', function(index){
                    window.location.href="<?php echo siteUrl('admin/meau/del_meau','','web'); ?>&id="+data.id;
                });
                ...
                layer.open({
                    ...
                    content:"<?php echo siteUrl('admin/meau/edit_meau',array('pid'=>0),'web'); ?>&type=1&id="+data.id,
                    success:function(){
                ...
                admin.req({
                    url:"<?php echo siteUrl('admin/meau/change','','web'); ?>&id="+data.id,
                    type:"POST",
                    done:res=>{
        ...
        var $ = layui.$, active = {
            addFirst: function(){ //添加
                ...
                layer.open({
                    ...
                    content:"<?php echo siteUrl('admin/meau/edit_meau',array('pid'=>0),'web'); ?>&type=1",
                    success:function(){
