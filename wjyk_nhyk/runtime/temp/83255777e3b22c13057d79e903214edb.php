<?php /*a:2:{s:76:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\group\index.html";i:1639920798;s:60:"../addons/wjyk_nhyk/application/admin/view/index/footer.html";i:1641211050;}*/ ?>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
					<div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
						<button class="layui-btn" data-type="addFirst">添加分组</button>
                    </div>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url:"<?php echo siteUrl('admin/group/cate_list','','web'); ?>"
            ,cols: [[
        ...
        table.on('tool(test-table-operate)', function(obj){
            var data = obj.data;
			if(obj.event === 'detail'){
            	window.location.href="<?php echo siteUrl('admin/group/edit_cate',array('pid'=>0),'web'); ?>&id="+data.id;
            } else if(obj.event === 'del'){
                layer.confirm('确定删除该类别吗', function(index){
                	window.location.href="<?php echo siteUrl('admin/group/del_cate','','web'); ?>&id="+data.id;
                });
            	...
            	layer.open({
                    ...
                    content:"<?php echo siteUrl('admin/group/edit_cate',array('pid'=>0),'web'); ?>&type=1&id="+data.id,
                    success:function(){
                ...
                admin.req({
                    url:"<?php echo siteUrl('admin/group/change','','web'); ?>&id="+data.id,
                    type:"POST",
                    done:res=>{
        ...
        var $ = layui.$, active = {
       		addFirst: function(){ //添加
       			...
       			layer.open({
                    ...
                    content:"<?php echo siteUrl('admin/group/edit_cate',array('pid'=>0),'web'); ?>&type=1",
                    success:function(){
