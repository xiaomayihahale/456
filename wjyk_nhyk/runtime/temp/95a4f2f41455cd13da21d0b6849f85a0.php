<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\meal\index.html";i:1639920798;s:60:"../addons/wjyk_nhyk/application/admin/view/index/footer.html";i:1641211050;}*/ ?>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn" data-type="addFirst">添加套餐</button>
                    </div>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url:"<?php echo siteUrl('admin/meal/meal_list','','web'); ?>"
            ,cols: [[
                {field:'order',  title: '排序值', sort: true}
                ,{field:'meal_name',  title: '套餐名称' }
                
                ,{field:'meal_count',  title: '套餐次数', sort: true}
                ,{field:'meal_money',  title: '套餐价格(元)', sort: true}
        ...
        table.on('tool(test-table-operate)', function(obj){
            var data = obj.data;
            if(obj.event === 'detail'){
                window.location.href="<?php echo siteUrl('admin/meal/edit_meal',array('pid'=>0),'web'); ?>&id="+data.id;
            } else if(obj.event === 'del'){
                layer.confirm('请确认无人使用该套餐卡 之后在删除 确定删除该套餐卡吗', function(index){
                    window.location.href="<?php echo siteUrl('admin/meal/del_meal','','web'); ?>&id="+data.id;
                });
                ...
                layer.open({
                    ...
                    content:"<?php echo siteUrl('admin/meal/edit_meal',array('pid'=>0),'web'); ?>&type=1&id="+data.id,
                    success:function(){
                ...
                admin.req({
                    url:"<?php echo siteUrl('admin/meal/change','','web'); ?>&id="+data.id,
                    type:"POST",
                    done:res=>{
        ...
        var $ = layui.$, active = {
            addFirst: function(){ //添加
                ...
                layer.open({
                    ...
                    content:"<?php echo siteUrl('admin/meal/edit_meal',array('pid'=>0),'web'); ?>&type=1",
                    success:function(){
