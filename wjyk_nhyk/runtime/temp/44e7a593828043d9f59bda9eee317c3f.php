<?php /*a:2:{s:74:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\goods\set.html";i:1639920798;s:60:"../addons/wjyk_nhyk/application/admin/view/index/footer.html";i:1641211050;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<form class="layui-form" style="margin-top:21px;">
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-block">
            <img class="layui-upload-img" id="dui_upload_img" style="margin-top: 10px;height: 150px;width: 150px" <?php if(!empty($system['dui_img'])): ?> src="<?php echo htmlentities($system['dui_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="dui_img" id="dui_upload_log"  class="carousel"  <?php if(!empty($system['dui_img'])): ?> value="<?php echo htmlentities($system['dui_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-block">
            <img class="layui-upload-img" id="new_good_upload_img" style="margin-top: 10px;height: 150px;width: 150px" <?php if(!empty($system['new_good_img'])): ?> src="<?php echo htmlentities($system['new_good_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="new_good_img" id="new_good_upload_log" class="carousel"  <?php if(!empty($system['new_good_img'])): ?> value="<?php echo htmlentities($system['new_good_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <img class="layui-upload-img" id="member_upload_img" style="margin-top: 10px;height: 150px;width: 150px" <?php if(!empty($system['member_img'])): ?> src="<?php echo htmlentities($system['member_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="member_img" id="member_upload_log" class="carousel"   <?php if(!empty($system['member_img'])): ?> value="<?php echo htmlentities($system['member_img']); ?>" <?php endif; ?> >
        </div>
    </div>
		   ...
		   <!--  预览图：
		    <div class="layui-upload-list"  id="ImgPreviewt" style="display: flex;"> 
	         	<?php if(!empty($system['carousel'])): foreach($system['carousel'] as $v): ?>
		  			<div class="image-container" id="containert<?php echo htmlentities($v); ?>">
				        <div class="delete-css">
		            		<div id="<?php echo htmlentities($v); ?>" class="upload_img layui-btn layui-btn-danger layui-btn-xs">删除</div>
		            	</div>
		                <img id="showImgt" style="width:150px; margin:10px;cursor:pointer;" src="<?php echo htmlentities($v); ?>"  >
      ...
      <div class="layui-input-block">
        <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
		    ...
		    <div class="layui-upload-list"  id="ImgPreviewTemps" style="display: flex;"> 
	         	<?php if(!empty($system['cate_carousel'])): foreach($system['cate_carousel'] as $v2): ?>
		  			<div class="image-container" id="containers<?php echo htmlentities($v2); ?>">
				        <div class="delete-css">
		            		<div id="<?php echo htmlentities($v2); ?>" class="upload_img layui-btn layui-btn-danger layui-btn-xs">删除</div>
		            	</div>
		                <img id="showImgs" style="width:150px; margin:10px;cursor:pointer;" src="<?php echo htmlentities($v2); ?>"  >
		                <input value="<?php echo htmlentities($v2); ?>" name="cate_carousel[]" class="carousel" type="hidden">
		            </div>
			        <?php endforeach; ?>
				<?php endif; ?>
	        </div>
...
<script>
	layui.config({
        ...
        if(check_data == null || !Array.isArray(check_data) ){
        	check_data = [];
        }
        table.render({
     ...
     /*        if($('.carousel').attr('value') == '' ||$('.carousel').attr('value') == null ){
            ...
            admin.req({
                url:"<?php echo siteUrl('admin/goods/set_system','','web'); ?>",
                data:data.field,
                type:"POST",
                done:res=>{
                    if(res.code == 0 ){
