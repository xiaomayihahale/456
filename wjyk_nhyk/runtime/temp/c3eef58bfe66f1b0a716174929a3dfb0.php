<?php /*a:2:{s:83:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\system\foods_index.html";i:1639920798;s:60:"../addons/wjyk_nhyk/application/admin/view/index/footer.html";i:1641211050;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<form class="layui-form" style="margin-top:21px;">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-form-mid layui-word-aux">建议上传100px * 100px尺寸</div>
        ...
        <div class="layui-input-block">
            <img class="layui-upload-img" id="demo6" style="margin-top: 10px;height: 150px;width: 150px" <?php if($system['index_share_img']==''): else: ?>src="<?php echo htmlentities($system['index_share_img']); ?>"<?php endif; ?>">
            <input type="hidden" name="index_share_img" id="logo6" value="<?php echo htmlentities($system['index_share_img']); ?>">
        </div>
  </div>
   ...
   <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="djq_name" required lay-verify="required"  autocomplete="off" class="layui-input" value="<?php echo htmlentities($system['djq_name']); ?>">
        </div>
    </div>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="wm_text" required lay-verify="required"  autocomplete="off" class="layui-input" value="<?php echo htmlentities($system['wm_text']); ?>">
        </div>
    </div>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="jiu_text" required lay-verify="required"  autocomplete="off" class="layui-input" value="<?php echo htmlentities($system['jiu_text']); ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-block">
            <img class="layui-upload-img" id="mei_upload_img" style="margin-top: 10px;height: 150px;width: 150px" <?php if(!empty($system['mei_img'])): ?> src="<?php echo htmlentities($system['mei_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="mei_img" id="mei_upload_log"  class="carousel"  <?php if(!empty($system['mei_img'])): ?> value="<?php echo htmlentities($system['mei_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-block">
            <img class="layui-upload-img" id="buy_upload_img" style="margin-top: 10px;height: 148px;width: 148px" <?php if(!empty($system['buy_img'])): ?> src="<?php echo htmlentities($system['buy_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="buy_img" id="buy_upload_log"  class="carousel"  <?php if(!empty($system['buy_img'])): ?> value="<?php echo htmlentities($system['buy_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-form-mid layui-word-aux">图片建议尺寸148rpx * 148rpx，或者等比例图片</div>
        <div class="layui-input-block">
            <img class="layui-upload-img" id="cj_upload_img" style="margin-top: 10px;height: 148px;width: 148px" <?php if(!empty($system['cj_img'])): ?> src="<?php echo htmlentities($system['cj_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="cj_img" id="cj_upload_log" class="carousel"  <?php if(!empty($system['cj_img'])): ?> value="<?php echo htmlentities($system['cj_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux">图片建议尺寸148rpx * 148rpx，或者等比例图片</div>
        <div class="layui-input-block">
            <img class="layui-upload-img" id="jf_upload_img" style="margin-top: 10px;height: 148px;width: 148px" <?php if(!empty($system['jf_img'])): ?> src="<?php echo htmlentities($system['jf_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="jf_img" id="jf_upload_log" class="carousel"   <?php if(!empty($system['jf_img'])): ?> value="<?php echo htmlentities($system['jf_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <img class="layui-upload-img" id="wm_upload_img" style="margin-top: 10px;height: 166px;width: 150px" <?php if(!empty($system['wm_img'])): ?> src="<?php echo htmlentities($system['wm_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="wm_img" id="wm_upload_log" class="carousel"   <?php if(!empty($system['wm_img'])): ?> value="<?php echo htmlentities($system['wm_img']); ?>" <?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux">图片建议尺寸166rpx * 150rpx，或者等比例图片</div>
        <div class="layui-input-block">
            <img class="layui-upload-img" id="jiu_upload_img" style="margin-top: 10px;height: 166px;width: 150px" <?php if(!empty($system['jiu_img'])): ?> src="<?php echo htmlentities($system['jiu_img']); ?>" <?php endif; ?> >
            <input type="hidden" name="jiu_img" id="jiu_upload_log" class="carousel"   <?php if(!empty($system['jiu_img'])): ?> value="<?php echo htmlentities($system['jiu_img']); ?>" <?php endif; ?> >
        </div>
    </div>
        ...
        <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
		   ...
		   <!--  预览图：
		    <div class="layui-upload-list"  id="ImgPreview" style="display: flex;"> 
	         	<?php if(!empty($system['carousel'])): foreach($system['carousel'] as $v): ?>
		  			<div class="image-container" id="container<?php echo htmlentities($v); ?>">
				        <div class="delete-css">
		            		<div id="<?php echo htmlentities($v); ?>" class="upload_img layui-btn layui-btn-danger layui-btn-xs">删除</div>
		            	</div>
		                <img id="showImg" style="width:150px; margin:10px;cursor:pointer;" src="<?php echo htmlentities($v); ?>"  >
		                <input value="<?php echo htmlentities($v); ?>" name="carousel[]" class="carousel" type="hidden">
		            </div>
			        <?php endforeach; ?>
				<?php endif; ?>
	        </div> -->
      ...
      <div class="layui-input-block">
        <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
		    ...
		    <div class="layui-upload-list"  id="ImgPreviewTemp1" style="display: flex;"> 
	         	<?php if(!empty($system['cate_carousel'])): foreach($system['cate_carousel'] as $v): ?>
		  			<div class="image-container" id="container1<?php echo htmlentities($v); ?>">
				        <div class="delete-css">
		            		<div id="<?php echo htmlentities($v); ?>" class="upload_img layui-btn layui-btn-danger layui-btn-xs">删除</div>
		            	</div>
		                <img id="showImg" style="width:150px; margin:10px;cursor:pointer;" src="<?php echo htmlentities($v); ?>"  >
		                <input value="<?php echo htmlentities($v); ?>" name="cate_carousel[]" class="carousel" type="hidden">
		            </div>
			        <?php endforeach; ?>
				<?php endif; ?>
	        </div>
      ...
      <div class="layui-input-block">
        <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
		    ...
		    <div class="layui-upload-list"  id="ImgPreviewTemp2" style="display: flex;"> 
	         	<?php if(!empty($system['djq_carousel'])): foreach($system['djq_carousel'] as $v): ?>
		  			<div class="image-container" id="container2<?php echo htmlentities($v); ?>">
				        <div class="delete-css">
		            		<div id="<?php echo htmlentities($v); ?>" class="upload_img layui-btn layui-btn-danger layui-btn-xs">删除</div>
		            	</div>
		                <img id="showImg" style="width:150px; margin:10px;cursor:pointer;" src="<?php echo htmlentities($v); ?>"  >
		                <input value="<?php echo htmlentities($v); ?>" name="djq_carousel[]" class="carousel" type="hidden">
		            </div>
			        <?php endforeach; ?>
				<?php endif; ?>
	        </div>
	...
	layui.config({
      ...
      //监听提交
        form.on('submit(demo1)', function(data){
            ...
            admin.req({
                url:"<?php echo siteUrl('admin/system/set_foods_system','','web'); ?>",
                data:data.field,
                type:"POST",
                done:res=>{
                    if(res.code == 0 ){
