<?php /*a:1:{s:80:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\group\edit_cate.html";i:1639920798;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<form class="layui-form" style="margin-top:21px;">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="group_name" required lay-verify="required" placeholder="请输入分组名称" autocomplete="off" class="layui-input" value="<?php echo htmlentities($srdb['group_name']); ?>">
    </div>
  </div>
  <div class="layui-form-item">
    ...
    layui.use(['jquery','form', 'laydate','upload'], function(){
      ...
      //监听提交
        form.on('submit(demo1)', function(data){
            ...
            admin.req({
                url:"<?php echo siteUrl('admin/group/edit_cate','','web'); ?>",
                data:data.field,
                type:"POST",
                done:res=>{
                	if(res.code == 0 ){
