<?php /*a:2:{s:79:"D:\phpstudy_pro\WWW\addons\wjyk_nhyk\application\admin\view\recharge\index.html";i:1639920798;s:60:"../addons/wjyk_nhyk/application/admin/view/index/footer.html";i:1641211050;}*/ ?>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                	<div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn" data-type="addStore">添加充值优惠</button>
                    </div>
...
<script>
    layui.config({
        ...
        table.render({
            ...
            ,url:"<?php echo siteUrl('admin/recharge/recharge_list','','web'); ?>"
            ,cols: [[
                {field:'sort',  title: '排序值', sort: true}
                ,{field:'money', title: '充值金额',templet:function(d){
                	return "充值"+d.money+"元";
                }}
                ,{field:'only', title: '赠送',templet:function(d){
                	return d.only+"元";
                }}
        ...
        table.on('tool(test-table-operate)', function(obj){
            var data = obj.data;
            if(obj.event === 'detail'){
            	window.location.href="<?php echo siteUrl('admin/recharge/edit_recharge','','web'); ?>&id="+data.id;
            } else if(obj.event === 'del'){
                layer.confirm('确定删除该充值优惠吗？', function(index){
                	window.location.href="<?php echo siteUrl('admin/recharge/del_recharge','','web'); ?>&id="+data.id;
                    layer.close(index);
                });
        ...
        table.on('toolbar(test-table-operate)', function(obj){
       	  ...
       	  switch(obj.event){
       	    case 'add':
       	    	window.location.href="<?php echo siteUrl('admin/recharge/edit_recharge','','web'); ?>";
       	    break;
       	  };
       	});
