(global["webpackJsonp"] = global["webpackJsonp"] || []).push([ [ "packages/takeawayOrder/NearbyStores/NearbyStores" ], {
    "189c": function(t, e, n) {
        "use strict";
        n.r(e);
        var o = n("562f"), s = n.n(o);
    ...
    "562f": function(t, e, n) {
        ...
        (function(t) {
            ...
            var i = {
                ...
                methods: {
                    store: function(e) {
                        console.log("item==========", e), getApp().globalData.coupon = e, 2 == this.options.indexs && (wx.setStorageSync("storeEatNexts", e.id), 
                        wx.setStorageSync("storeEatNextNames", e.store_name), wx.setStorageSync("storeJuli", e.juli), 
                        console.log("this.options.indexs", this.options.indexs), t.navigateBack());
                    },
                    maps: function() {
                        var e = this;
                        t.chooseLocation({
                            ...
                            return o.default.wrap(function(e) {
                                while (1) switch (e.prev = e.next) {
                                  ...
                                  case 2:
                                    ...
                                    t.distance_limit = Number(n.data.distance_limit) / 1e3, s = "附近门店", t.tabbarsss.filter(function(e) {
                                        e.meau_name == s && (t.index = e.index);
                                    }), console.log("index=", t.index, "this.distance_limit", t.distance_limit), console.log("member_back_logo", t.menkey), 
                                    console.log("member_back_logo", t.tabbarsss, t.tabbarsss.index));
...
}, [ [ "e5cc", "common/runtime", "common/vendor" ] ] ]);