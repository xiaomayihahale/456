(global["webpackJsonp"] = global["webpackJsonp"] || []).push([ [ "components/rich-parser/rich-parser" ], {
    "03f8": function(t, e, n) {},
    "141b": function(t, e, n) {
        "use strict";
        n.r(e);
        var i = n("d9a6"), o = n.n(i);
    ...
    6057: function(t, e, n) {
        ...
        n("c589");
        var r, a = n("f0c5"), c = Object(a["a"])(o["default"], i["b"], i["c"], !1, null, null, null, !1, i["a"], r);
        e["default"] = c.exports;
    },
    c589: function(t, e, n) {
        "use strict";
        var i = n("03f8"), o = n.n(i);
        o.a;
    },
    d9a6: function(t, e, n) {
        "use strict";
        (function(t) {
            ...
            var i, o = function() {
                n.e("components/rich-parser/libs/trees").then(function() {
                    return resolve(n("ca7f"));
                }.bind(null, n)).catch(n.oe);
            }, s = {}, r = t.getFileSystemManager ? t.getFileSystemManager() : null, a = n("ac5d");
            function c(t) {
            ...
            var l = {
                    ...
                    this.imgList = [], this.imgList.each = function(t) {
                        ...
                        if (void 0 != t && e) {
                            if (0 == e.indexOf("http") && this.includes(e)) {
                                for (var i, o = e.split("://")[0], s = o.length; i = e[s]; s++) {
                                    if ("/" == i && "/" != e[s - 1] && "/" != e[s + 1]) break;
                                    o += Math.random() > .5 ? i.toUpperCase() : i;
                                }
                                return o += e.substr(s), this[t] = o;
                            }
                            if (this[t] = e, e.includes("data:image")) {
                                var a, c = e.match(/data:image\/(\S+?);(\S+?),(.+)/);
                                if (!c) return;
                ...
                beforeDestroy: function() {
                    this.imgList.each(function(e) {
                        e && e.includes(t.env.USER_DATA_PATH) && r && r.unlink({
                            filePath: e
                        });
                ...
                methods: {
                    setContent: function(e, n) {
                        ...
                        var r, l = new a(e, this);
                        if (this.useCache) {
                            var h = c(e);
                            s[h] ? i = s[h] : (i = l.parse(), s[h] = i);
                        } else i = l.parse();
                        this.$emit("parse", i), this.nodes = n ? this.nodes.concat(i) : i, i.length && i.title && this.autosetTitle && t.setNavigationBarTitle({
                            ...
                            t.createSelectorQuery().in(o).select("#_top").boundingClientRect().exec(function(t) {
                                t && (o.rect = t[0], o.rect.height == r && (o.$emit("ready", o.rect), clearInterval(o._timer)), 
                                r = o.rect.height);
                            });
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([ "components/rich-parser/rich-parser-create-component", {
    "components/rich-parser/rich-parser-create-component": function(module, exports, __webpack_require__) {
        __webpack_require__("543d")["createComponent"](__webpack_require__("6057"));
    }
}, [ [ "components/rich-parser/rich-parser-create-component" ] ] ]);