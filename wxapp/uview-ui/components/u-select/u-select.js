(global["webpackJsonp"] = global["webpackJsonp"] || []).push([ [ "uview-ui/components/u-select/u-select" ], {
        ...
        var u = {
            ...
            methods: {
                ...
                setColumnData: function() {
                    var t = [];
                    if (this.selectValue = [], "mutil-column-auto" == this.mode) for (var e = this.list[this.defaultSelector.length ? this.defaultSelector[0] : 0], l = 0; l < this.columnNum; l++) 0 == l ? (t[l] = this.list, 
                    e = e[this.childName]) : (t[l] = e, e = e[this.defaultSelector[l]][this.childName]); else "single-column" == this.mode ? t[0] = this.list : t = this.list;
                    this.columnData = t;
                },
                setSelectValue: function() {
                    for (var t = null, e = 0; e < this.columnNum; e++) {
                        ...
                        t && t.extra && (l.extra = t.extra), this.selectValue.push(l);
                    }
                },
                columnChange: function(t) {
                    var e = this, l = null, u = t.detail.value;
                    if (this.selectValue = [], "mutil-column-auto" == this.mode) {
                        ...
                        u.map(function(t, l) {
                            var n = e.columnData[l][u[l]], a = {
                                value: n ? n[e.valueName] : null,
                                label: n ? n[e.labelName] : null
                            };
                            n && void 0 !== n.extra && (a.extra = n.extra), e.selectValue.push(a);
                    ...
                    } else "mutil-column" == this.mode && u.map(function(t, l) {
                        var n = e.columnData[l][u[l]], a = {
                            value: n ? n[e.valueName] : null,
                            label: n ? n[e.labelName] : null
                        };
                ...
                getResult: function() {
                    ...
                    this.moving || (t && this.$emit(t, this.selectValue), this.close());
                },
    ...
    7190: function(t, e, l) {
        ...
        var u = {
            uPopup: function() {
                return l.e("uview-ui/components/u-popup/u-popup").then(l.bind(null, "894f"));
            }
        }, n = function() {
    ...
    "73e8": function(t, e, l) {
        ...
        l("f29f");
        var i, s = l("f0c5"), o = Object(s["a"])(n["default"], u["b"], u["c"], !1, null, "690e2e06", null, !1, u["a"], i);
        e["default"] = o.exports;
    },
    c9c0: function(t, e, l) {
        "use strict";
        l.r(e);
        var u = l("32ae"), n = l.n(u);
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([ "uview-ui/components/u-select/u-select-create-component", {
    "uview-ui/components/u-select/u-select-create-component": function(module, exports, __webpack_require__) {
        __webpack_require__("543d")["createComponent"](__webpack_require__("73e8"));
    }
